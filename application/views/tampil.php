...
<div class="container">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="margin:24px 0;">
		<a class="navbar-brand" href="javascript:void(0)">DAFTAR REKOM/MUTASI SISWA KOTA SURABAYA</a>
		...
		<div class="collapse navbar-collapse" id="navb">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item">
					<a class="nav-link disabled" href="javascript:void(0)"><?php echo $this->session->userdata('')?></a>
				</li>
			</ul>
  ...
  <table class="table table-striped">
		...
		<tr>
			...
			<td><?php echo $no++ ?></td>
			<td><?php echo $u->th_ajaran ?></td>
			<td><?php echo $u->nama ?></td>
			<td><?php echo $u->nisn ?></td>
			<td><?php echo $u->asal ?></td>
			<td><?php echo $u->nama_ortu ?></td>
			<td><?php echo $u->no_ortu ?></td>
